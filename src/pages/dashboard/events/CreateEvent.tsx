    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert(result.message || "Gagal membuat event baru");
            }
        } catch (error) {
    ...
    return (
        <div className="p-5">
            <div className="text-center mb-6">
                <h2 className="text-red-900 font-semibold text-4xl">Create new Event</h2>
                <p className="text-gray-600">Buat kegiatan baru dengan relasi data terintegrasi</p>
            </div>

            <div className="flex justify-center">
                <div className="flex bg-[#FEE3EC] p-8 rounded-xl w-full max-w-lg shadow-md">
                    <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select
                                {...register("categoryId")}
                                className="w-full px-3 py-2 bg-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                            >
                        ...
                        <div className="flex flex-col border-t pt-3 mt-1 border-pink-200">
