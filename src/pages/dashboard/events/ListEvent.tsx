                        ...
                        >
                            ...
                            <div className="flex md:flex-col gap-2 justify-end items-end">
                                <Link 
                                    ...
                                    className="px-3 py-1 bg-amber-500 text-white text-sm rounded hover:bg-amber-600 transition text-center w-20"
                                >
                                    Edit
                                </Link>
                                <button 
                                    onClick={() => handleDelete(event.id)}
                                    className="px-3 py-1 bg-red-600 text-white text-sm rounded hover:bg-red-700 transition text-center w-20"
                                >
                                    Hapus
                                </button>
                            </div>
